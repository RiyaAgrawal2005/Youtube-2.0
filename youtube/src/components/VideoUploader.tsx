...
const VideoUploader = ({ channelId, channelName }: any) => {
  ...
  // const [posterPath, setPosterPath] = useState(""); // <-- Add this
  ...
  const handleUpload = async () => {
    ...
    // formdata.append("posterpath", posterPath); // ✅ Add this line
...
//   {/* <div>
//     <Label htmlFor="posterpath">Poster Path (optional)</Label>
//     <Input
//       id="posterpath"
//       value={posterPath}
//       onChange={(e) => setPosterPath(e.target.value)}
//       placeholder="/posters/your-image.jpg"
//       disabled={isUploading || uploadComplete}
//       className="mt-1"
//     />
//   </div> */}
...
return (
  <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
    <h2 className="text-xl font-semibold mb-4 text-black dark:text-white">Upload a video</h2>

    <div className="space-y-4">
      {!videoFile ? (
        <div
          className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-8 text-center cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
          onClick={() => fileInputRef.current?.click()}
        >
          <Upload className="w-12 h-12 mx-auto text-gray-400 dark:text-gray-300 mb-2" />
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3 p-3 bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
            ...
            <div className="flex-1 min-w-0">
              <p className="font-medium truncate text-black dark:text-white">{videoFile.name}</p>
          ...
          <div className="space-y-3">
            <div>
              <Label htmlFor="title" className="text-black dark:text-white">Title (required)</Label>
              <Input
                id="title"
                value={videoTitle}
                onChange={(e) => setVideoTitle(e.target.value)}
